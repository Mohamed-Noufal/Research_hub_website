...
class RAGEngine:
    ...
    async def ingest_paper_with_docling(
        ...
        # Iterate over items in the Docling document structure
        # Note: API might vary slightly by Docling version; verify iterate_items() exists or use appropriate iterator
        # Assuming standard Docling usage:
    ...
    async def query(
        ...
        logger.info(f"  🧠 Searching with YOUR Nomic embeddings...")
